...
export function ResourceMarket({ state, act }: { state: g.GameState; act: Dispatch }) {
  ...
  return <section className="panel order-card">
    <h1>Ürün pazarı</h1>
    <p>Tüm üretim ürünlerini sat veya eksik malzemeleri sipariş et. Satın alınan ürünler hemen depoya gelir. Hayvanlar yem stokunu otomatik kullanır; ekipmanları saha ekranından stoktan kullanabilirsin.</p>
    <div className="network-form">
      ...
      <span>Stok: {state.stock[resource]} / {state.warehouseCapacity[resource]}</span>
